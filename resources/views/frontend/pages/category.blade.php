                                ...
                                <div>
                                    <div id="container">
                                        ...
                                        <div class="col-md-6 top-text two">
                                            ...
                                            <p>
                                                On {{ $post->created_at}}
                                                <a class="span_link" href="#"><span class="glyphicon glyphicon-comment"></span>0 </a><a class="span_link"
                                            ...
                                            <a href="{{  route('postView',['id'=>$post->id]) }}">
                                                <li>
                                                    ...
                                                    <section class="list-right">
                                                        <span class="date">{{\Carbon\Carbon::parse($post->created_at)->format('d M H:i')}}</span>
