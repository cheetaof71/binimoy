            ...
            <div class="side-bar col-md-3">
                ...
                <div class="featured-ads">
                    ...
                    <div class="featured-ad">
                        <a href="single.html">
                            <div class="featured-ad-left">
                                <img src="{{ asset('') }}images/f1.jpg" title="ad image" alt="" />
                            </div>
                    ...
                    <div class="featured-ad">
                        <a href="single.html">
                            <div class="featured-ad-left">
                                <img src="{{ asset('') }}images/f2.jpg" title="ad image" alt="" />
                            </div>
                            <div class="featured-ad-right">
                                <h4>Lorem Ipsum is simply dummy text of the printing industry</h4>
                                <p>$ 380</p>
                    ...
                    <div class="featured-ad">
                        <a href="single.html">
                            <div class="featured-ad-left">
                                <img src="{{ asset('') }}images/f3.jpg" title="ad image" alt="" />
                            </div>
                            <div class="featured-ad-right">
                                <h4>Lorem Ipsum is simply dummy text of the printing industry</h4>
                                <p>$ 560</p>
                                    ...
                                    <div id="container">
                                        ...
                                        <div class="col-md-6 top-text two">
                                            <a href="{{  route('postView',['id'=>$post->id]) }}">
                                                ...
                                                <img src="{{ asset($image) }}" height="10" class="img-responsive"
                                                    alt="IMage Here">
                                                @break;
                                                @endforeach
                                            </a>
                                            ...
                                            <p>
                                                ...
                                                <a class="span_link" href="#"><span
                                                    ...
                                                    href="{{  route('postView',['id'=>$post->id]) }}"><span
                                        ...
                                        <ul class="list">
                                            ...
                                            <a href="{{  route('postView',['id'=>$post->id]) }}">
                                                <li>
                                                    @foreach (json_decode($post->post_image) as $image)
                                                    <img src="{{ asset($image) }}" title="" alt="" />
                                                    {{-- <img src="{{ asset($image) }}" height="10"
                                                        class="img-responsive" alt="IMage Here"> --}}
                                                    @break;
                                                    @endforeach
                                                    <section class="list-left">
                                                        <h5 class="title">{{ $post->post_title}}</h5>
                                                        <span class="adprice">${{ $post->price}}</span>
                                                        <p class="catpath">Brand » {{ $post->brand}}</p>
                                                    </section>
                                                    <section class="list-right">
                                                        <span
                                                            class="date">{{\Carbon\Carbon::parse($post->created_at)->format('d
                                                            M H:i')}}</span>
